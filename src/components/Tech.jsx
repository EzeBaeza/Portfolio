  ...
  return (
    ...
    items-center justify-center gap-16 md:gap-32'>
      ...
      <div className='flex flex-wrap items-center justify-center gap-10 p-5'>
        ...
        >
          <BiLogoTypescript className='cursor-pointer text-[80px] text-sky-500 transition-all
        ...
        <motion.div
          ...
          transition={{duration:0.5}}
        >
          <BiLogoTailwindCss className='cursor-pointer text-[80px] text-sky-400 transition-all
        duration-300 hover:-translate-y-5 sm:text[100px] md:text-[120px]'/>
        </motion.div>
